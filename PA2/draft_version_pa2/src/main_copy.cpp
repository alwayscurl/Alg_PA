...
int Maximum_chords(int i, int k, int &node_num, unordered_map<int, int>& chord_endpoint, int** &max_subchordnum, int** &chosen_chord){
    if(i > k){
        return 0;
    }
...
void Maximum_planar_subset(int &node_num, unordered_map<int, int>& chord_endpoint, int** max_subchordnum, int** chosen_chord, int& max_chord_num){
